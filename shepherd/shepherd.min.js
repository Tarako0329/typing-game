...
(this, function () {
  function O(a, b) {
    return !1 !== b.clone && b.isMergeableObject(a) ? da(Array.isArray(a) ? [] : {}, a, b) : a
  }
  ...
  function Eb(a, b, c) {
    var d = {};
    c.isMergeableObject(a) && Ta(a).forEach(function (e) {
      d[e] = O(a[e], c)
    });
    Ta(b).forEach(function (e) {
      if (!Ua(a, e) || Object.hasOwnProperty.call(a, e) && Object.propertyIsEnumerable.call(a, e))
  ...
  function ra(a) {
    for (var b = K(a), c = Xa(a); c && 0 <= ["table", "td", "th"].indexOf(M(c)) && "static" === P(c).position;) c = Xa(c);
  ...
  function $a(a) {
    ...
    if (k) {
      ...
      if ("left" === e || ("top" === e || "bottom" === e) && "end" === f) x = "right", a -= (q && v === t && t.visualViewport ? t.visualViewport.width : v[u]) - d.width, a *= m ? 1 : -1
    }
    c = Object.assign({
      position: l
    }, k && Ib);
  ...
  function bb(a) {
    return 0 <= ["html", "body", "#document"].indexOf(M(a)) ? a.ownerDocument.body : F(a) && Ja(a) ? a : bb(wa(a))
  }
  ...
  function Xb(a, b) {
    ...
    (a = b.tour && b.tour.options && b.tour.options.defaultStepOptions) && (c = kb(a, c));
  ...
  function ob() {
    ...
    do {
      ...
      for (b = 0; b < Aa.length; b += 1) c = Aa[b], Pa.has(c) || (Pa.add(c), c());
      Aa.length = 0
    } while (va.length);
  ...
  function C(a, b, c, d) {
    a && a.o && !Ca.has(a) && (Ca.add(a), aa.c.push(() => {
      Ca.delete(a);
      d && (c && a.d(1), d())
    }), a.o(b))
  }
  ...
  function S(a, b, c, d, e, f, g, l) {
    ...
    k.ctx = c ? c(a, b.props || {}, function (q, n) {
      ...
      if (k.ctx && e(k.ctx[q], k.ctx[q] = r)) {
        ...
        p && (-1 === a.$$.dirty[0] && (va.push(a), Qa || (Qa = !0, Zb.then(ob)), a.$$.dirty.fill(0)), a.$$.dirty[q / 31 | 0] |= 1 << q % 31)
      }
      return n
    }) : [];
    k.update();
  ...
  function cc(a) {
    ...
    return {
      ...
      p(e, f) {
        [f] = f;
        e[1] ? d ? (d.p(e, f), f & 2 && z(d, 1)) : (d = rb(e), d.c(), z(d, 1), d.m(b, null)) : d && (Z(), C(d, 1, 1, () => {
          d = null
        }), ba())
      },
      i(e) {
  ...
  function kc(a) {
    ...
    return {
      ...
      p(g, l) {
        [l] = l;
        g[2] ? e ? (e.p(g, l), l & 4 && z(e, 1)) : (e = tb(g), e.c(), z(e, 1), e.m(b, c)) : e && (Z(), C(e, 1, 1, () => {
          e = null
        }), ba());
        g[3] && g[3].enabled ? f ? (f.p(g, l), l & 8 && z(f, 1)) : (f = ub(g), f.c(), z(f, 1), f.m(b, null)) : f && (Z(), C(f, 1, 1, () => {
          f = null
        }), ba())
      },
      i(g) {
  ...
  function rc(a) {
    ...
    return {
      ...
      p(q, n) {
        ...
        c ? m ? (m.p(q, n), n & 4 && z(m, 1)) : (m = vb(q), m.c(), z(m, 1), m.m(b, d)) : m && (Z(), C(m, 1, 1, () => {
          m = null
        }), ba());
        n & 4 && (e = void 0 !== q[2].options.text);
        e ? k ? (k.p(q, n), n & 4 && z(k, 1)) : (k = wb(q), k.c(), z(k, 1), k.m(b, f)) : k && (Z(), C(k, 1, 1, () => {
          k = null
        }), ba());
        n & 4 && (g = Array.isArray(q[2].options.buttons) && q[2].options.buttons.length);
        g ? p ? (p.p(q, n), n & 4 && z(p, 1)) : (p = xb(q), p.c(), z(p, 1), p.m(b, null)) : p && (Z(), C(p, 1, 1, () => {
          p = null
        }), ba())
      },
      i(q) {
  ...
  function vc(a, b, c) {
    ...
    return [e, q, f, m, p, n, r, h => {
      ...
      case 9:
        ...
        } else document.activeElement === k && (h.preventDefault(), g.focus());
        break;
      case 27:
...
Z`)
    ...
    Bc = function (a) {
      ...
      defaultModifiers: [{
        ...
        fn: function (a) {
          ...
          null != b.modifiersData.popperOffsets && (b.styles.popper = Object.assign({}, b.styles.popper, $a(Object.assign({}, a, {
            offsets: b.modifiersData.popperOffsets,
            position: b.options.strategy,
            adaptive: d,
            roundOffsets: c
          }))));
          null != b.modifiersData.arrow && (b.styles.arrow = Object.assign({}, b.styles.arrow, $a(Object.assign({}, a, {
            ...
            if (p)
              for (d = function (E) {
                  var I = r.find(function (D) {
                    if (D = x.get(D)) return D.slice(0, E).every(function (na) {
                      return na
                    })
                  });
        ...
        fn: function (a) {
          ...
          if (d) {
            if (e) {
              ...
              w = (w = b.elements.arrow && ra(b.elements.arrow)) ? "y" === n ? w.clientTop || 0 : w.clientLeft || 0 : 0;
        ...
        fn: function (a) {
          ...
          if (f && g) {
            ...
            f = (f = ra(f)) ? "y" === a ? f.clientHeight || 0 : f.clientWidth || 0 : 0;
            g = f / 2 - m[l] / 2 + (q / 2 - g / 2);
      ...
      a.exports = {
        polyfill: function () {
          ...
          function d(h) {
            ...
            throw new TypeError("behavior member of ScrollOptions " + h.behavior + " is not a valid value for enumeration ScrollBehavior.");
          }
          ...
          if (!("scrollBehavior" in p.documentElement.style && !0 !== k.__forceSmoothScrollPolyfill__)) {
            ...
            q.prototype.scroll = q.prototype.scrollTo = function (h, t) {
              if (void 0 !== h)
                if (!0 === d(h)) {
                  ...
                  n.elementScroll.call(this, void 0 !== h.left ? ~~h.left : "object" !== typeof h ? ~~h : this.scrollLeft, void 0 !== h.top ? ~~h.top : void 0 !== t ? ~~t : this.scrollTop)
            ...
            q.prototype.scrollIntoView = function (h) {
              if (!0 === d(h)) n.scrollIntoView.call(this, void 0 === h ? !0 : h);
              else {
  ...
  class Sa extends Ra {
    ...
    _scrollTo(a) {
      ...
      ea(this.options.scrollToHandler) ? this.options.scrollToHandler(b) : b instanceof Element && "function" === typeof b.scrollIntoView && b.scrollIntoView(a)
    }
    _getClassOptions(a) {
  ...
  class Ec extends Ra {
    ...
    constructor(a) {
      let callback = '';    //tourstart()の第1引数：ajax関数による記録用
      let tourKind = '';    //tourstart()の第2引数：ツアーの種類
      let tourStatus = '';  //tourstart()の第3引数：action finish or save でDBに記録
      void 0 === a && (a = {});
      super(a);
      Va(this);
      this.options = Object.assign({}, {
    ...
    nextAndSave() {
      this.callback(this.tourKind,this.options.tourName,this.tourStatus);
      let a = this.steps.indexOf(this.currentStep);
      a === this.steps.length - 1 ? this.complete() : this.show(a + 1, !0)
    }
    removeStep(a) {
    ...
    show(a, b) {
      void 0 === a && (a = 0);
      void 0 === b && (b = !0);
      if (a = qa(a) ? this.getById(a) : this.steps[a]) this._updateStateBeforeShow(), ea(a.options.showOn) && !a.options.showOn() ? this._skipStep(a, b) : (this.trigger("show", {
        step: a,
        previous: this.currentStep
      }), this.currentStep = a, a.show())
    }
    start(callback_func,tourKind,tourStatus) {
      this.callback = callback_func; //tourFinish = function (tourName,step,status)
    ...
    _done(a) {
      ...
      "cancel" !== a && "complete" !== a && "skip" !== a || !this.modal || (a = document.querySelector(".shepherd-modal-overlay-container")) && a.remove();
      ...
      if(status==="skip"){
          //alert("skip");
          this.callback(this.tourKind,this.options.tourName,"finish");
      }
      if(status==="cancel"){
          //alert("cancel");
          this.callback("","","");
    ...
    _skipStep(a, b) {
      ...
      a === this.steps.length - 1 ? this.complete() : this.show(b ? a + 1 : a - 1, b)
    }
